...
from infrastructure.data_access.analytics.analytics_mapper import AnalyticsMapper
from infrastructure.data_access.analytics.analytics_model import AnalyticsModel

class AnalyticsRepository:
    def __init__(self, session: AsyncSession):
        self.session = session
        
    async def get_analytics_by_mission_id(self, mission_id: str) -> Analytics | None:
        try:
